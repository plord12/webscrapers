...
EVENTS_NAME=events
EVENTS_SOURCE=${EVENTS_NAME}/${EVENTS_NAME}.go ${EVENTS_NAME}/perftests.go ${EVENTS_NAME}/cachetests.go ${EVENTS_NAME}/exchangerates.go ${EVENTS_NAME}/eventbrite.go ${EVENTS_NAME}/gresham.go ${EVENTS_NAME}/rigb.go ${EVENTS_NAME}/york.go ${EVENTS_NAME}/ucl.go
