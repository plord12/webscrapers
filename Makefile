...
AVIVAMYWORKPLACE_NAME=avivamyworkplace
AVIVAMYWORKPLACE_SOURCE=${AVIVAMYWORKPLACE_NAME}/${AVIVAMYWORKPLACE_NAME}.go
NUTMEG_NAME=nutmeg
...
OCTOPUSREWARDS_NAME=octopusrewards
...
OTPCGI_NAME=otpcgi
OTPCGI_SOURCE=${OTPCGI_NAME}/${OTPCGI_NAME}.go
SMTP2GOCGI_NAME=smtp2gocgi
SMTP2GOCGI_SOURCE=${SMTP2GOCGI_NAME}/${SMTP2GOCGI_NAME}.go
...
EVENTS_NAME=events
EVENTS_SOURCE=${EVENTS_NAME}/${EVENTS_NAME}.go ${EVENTS_NAME}/perftests.go ${EVENTS_NAME}/cachetests.go ${EVENTS_NAME}/exchangerates.go 
EVENTS_SOURCE+=${EVENTS_NAME}/eventbrite.go 
EVENTS_SOURCE+=${EVENTS_NAME}/gresham.go 
EVENTS_SOURCE+=${EVENTS_NAME}/rigb.go 
EVENTS_SOURCE+=${EVENTS_NAME}/york.go 
EVENTS_SOURCE+=${EVENTS_NAME}/ucl.go 
EVENTS_SOURCE+=${EVENTS_NAME}/linnean.go 
...
BINARIES+=${BINDIR}/${AVIVAMYWORKPLACE_NAME} 
...
release-webscrapers-linux-arm64: ${LINUXARM64BINDIR}/${AVIVA_NAME} ${LINUXARM64BINDIR}/${AVIVAMYWORKPLACE_NAME} ${LINUXARM64BINDIR}/${NUTMEG_NAME} ${LINUXARM64BINDIR}/${FUND_NAME} ${LINUXARM64BINDIR}/${MONEYFARM_NAME} ${LINUXARM64BINDIR}/${OCTOPUSWHEEL_NAME} ${LINUXARM64BINDIR}/${MYCAUSEUK_NAME}
	cd ${LINUXARM64BINDIR} && zip ../webscrapers-linux-arm64-${VERSION}.zip $(notdir $^)

release-webscrapers-linux-amd64: ${LINUXAMD64BINDIR}/${AVIVA_NAME} ${LINUXAMD64BINDIR}/${AVIVAMYWORKPLACE_NAME} ${LINUXAMD64BINDIR}/${NUTMEG_NAME} ${LINUXAMD64BINDIR}/${FUND_NAME} ${LINUXAMD64BINDIR}/${MONEYFARM_NAME} ${LINUXAMD64BINDIR}/${OCTOPUSWHEEL_NAME} ${LINUXAMD64BINDIR}/${MYCAUSEUK_NAME}
	cd ${LINUXAMD64BINDIR} && zip ../webscrapers-linux-amd64-${VERSION}.zip $(notdir $^)

release-webscrapers-darwin-arm64: ${DARWINARM64BINDIR}/${AVIVA_NAME} ${DARWINARM64BINDIR}/${AVIVAMYWORKPLACE_NAME} ${DARWINARM64BINDIR}/${NUTMEG_NAME} ${DARWINARM64BINDIR}/${FUND_NAME} ${DARWINARM64BINDIR}/${MONEYFARM_NAME} ${DARWINARM64BINDIR}/${OCTOPUSWHEEL_NAME} ${DARWINARM64BINDIR}/${MYCAUSEUK_NAME}
...
# aviva my workplace
#
${BINDIR}/${AVIVAMYWORKPLACE_NAME}: ${AVIVAMYWORKPLACE_SOURCE} ${UTILS_SOURCE}
	go build -o $@ $<
${LINUXARM64BINDIR}/${AVIVAMYWORKPLACE_NAME}: ${AVIVAMYWORKPLACE_SOURCE} ${UTILS_SOURCE}
	GOARCH=arm64 GOOS=linux go build -o $@ $<
${LINUXAMD64BINDIR}/${AVIVAMYWORKPLACE_NAME}: ${AVIVAMYWORKPLACE_SOURCE} ${UTILS_SOURCE}
	GOARCH=amd64 GOOS=linux go build -o $@ $<
${DARWINARM64BINDIR}/${AVIVAMYWORKPLACE_NAME}: ${AVIVAMYWORKPLACE_SOURCE} ${UTILS_SOURCE}
	GOARCH=arm64 GOOS=darwin go build -o $@ $<
${WINDOWSAMD64BINDIR}/${AVIVAMYWORKPLACE_NAME}.exe: ${AVIVAMYWORKPLACE_SOURCE} ${UTILS_SOURCE}
	GOARCH=amd64 GOOS=windows go build -o $@ $<
...
# octopus rewards
#
${BINDIR}/${OCTOPUSREWARDS_NAME}: ${OCTOPUSREWARDS_SOURCE} ${UTILS_SOURCE}
	go build -o $@ $<
${LINUXARM64BINDIR}/${OCTOPUSREWARDS_NAME}: ${OCTOPUSREWARDS_SOURCE} ${UTILS_SOURCE}
	GOARCH=arm64 GOOS=linux go build -o $@ $<
${LINUXAMD64BINDIR}/${OCTOPUSREWARDS_NAME}: ${OCTOPUSREWARDS_SOURCE} ${UTILS_SOURCE}
	GOARCH=amd64 GOOS=linux go build -o $@ $<
${DARWINARM64BINDIR}/${OCTOPUSREWARDS_NAME}: ${OCTOPUSREWARDS_SOURCE} ${UTILS_SOURCE}
	GOARCH=arm64 GOOS=darwin go build -o $@ $<
${WINDOWSAMD64BINDIR}/${OCTOPUSREWARDS_NAME}.exe: ${OCTOPUSREWARDS_SOURCE} ${UTILS_SOURCE}
	GOARCH=amd64 GOOS=windows go build -o $@ $<
...
# otpcgi
#
${BINDIR}/${OTPCGI_NAME}: ${OTPCGI_SOURCE}
	go build -o $@ $<
${LINUXARM64BINDIR}/${OTPCGI_NAME}: ${OTPCGI_SOURCE}
	GOARCH=arm64 GOOS=linux go build -o $@ $<
${LINUXAMD64BINDIR}/${OTPCGI_NAME}: ${OTPCGI_SOURCE}
	GOARCH=amd64 GOOS=linux go build -o $@ $<
${DARWINARM64BINDIR}/${OTPCGI_NAME}: ${OTPCGI_SOURCE}
	GOARCH=arm64 GOOS=darwin go build -o $@ $<
${WINDOWSAMD64BINDIR}/${OTPCGI_NAME}.exe: ${OTPCGI_SOURCE}
	GOARCH=amd64 GOOS=windows go build -o $@ $<

# smtp2gocgi
#
${BINDIR}/${SMTP2GOCGI_NAME}: ${SMTP2GOCGI_SOURCE}
	go build -o $@ $<
${LINUXARM64BINDIR}/${SMTP2GOCGI_NAME}: ${SMTP2GOCGI_SOURCE}
	GOARCH=arm64 GOOS=linux go build -o $@ $<
${LINUXAMD64BINDIR}/${SMTP2GOCGI_NAME}: ${SMTP2GOCGI_SOURCE}
	GOARCH=amd64 GOOS=linux go build -o $@ $<
${DARWINARM64BINDIR}/${SMTP2GOCGI_NAME}: ${SMTP2GOCGI_SOURCE}
	GOARCH=arm64 GOOS=darwin go build -o $@ $<
${WINDOWSAMD64BINDIR}/${SMTP2GOCGI_NAME}.exe: ${SMTP2GOCGI_SOURCE}
	GOARCH=amd64 GOOS=windows go build -o $@ $<

# facebook
#
${BINDIR}/${FACEBOOK_NAME}: ${FACEBOOK_SOURCE}
	go build -o $@ $<
${LINUXARM64BINDIR}/${FACEBOOK_NAME}: ${FACEBOOK_SOURCE}
	GOARCH=arm64 GOOS=linux go build -o $@ $<
${LINUXAMD64BINDIR}/${FACEBOOK_NAME}: ${FACEBOOK_SOURCE}
	GOARCH=amd64 GOOS=linux go build -o $@ $<
${DARWINARM64BINDIR}/${FACEBOOK_NAME}: ${FACEBOOK_SOURCE}
	GOARCH=arm64 GOOS=darwin go build -o $@ $<
...
${BINDIR}/${EVENTS_NAME}: ${EVENTS_SOURCE} ${UTILS_SOURCE} tokenizers/libtokenizers.a
	CGO_LDFLAGS=-Ltokenizers go build -tags ORT,XLA -o $@ ${EVENTS_SOURCE}
